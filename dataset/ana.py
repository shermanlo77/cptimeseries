...
PATH_TO_MODEL_FIELD = path.join(pathlib.Path(__file__).parent.absolute(),
                                "..", "Data", "ana")
...
PATH_TO_RAIN = path.join(pathlib.Path(__file__).parent.absolute(),
                         "..", "Data", "eobs")
RAIN_FILE = path.join(PATH_TO_RAIN,
                      "rr_ens_mean_0.1deg_reg_v20.0e_197901-201907_uk.nc")
PATH_TO_TOPO = path.join(pathlib.Path(__file__).parent.absolute(),
                         "..", "Data", "topo")

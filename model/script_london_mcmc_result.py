...
import numpy as np
from get_data import get_london_rain_training, get_london_rain_test
from get_data import get_london_model_field_test
...
def main():
    ...
    print_forecast(time_series, 
                   get_london_rain_training(), 
                   np.asarray(get_london_model_field_test()),
                   get_london_rain_test(),
                   directory)
